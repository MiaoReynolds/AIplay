...
<div class="bento-grid">
  ...
  <div class="bento-card">
    <div class="bento-content-wrapper">
      <div class="team-avatar-wrapper">
        <img src="../assets/images/hermes_agent.jpg" alt="Hermes Agent">
      </div>
      <h3 class="bento-title">Hermes Agent</h3>
      <div class="bento-subtitle">Autonomous AI Operator (Non-Human)</div>
      <p class="bento-desc">Hermes Agent is our tireless digital operator: part research analyst, part coding assistant, part operations secretary, and part midnight co-founder who never asks for coffee. It can monitor tasks, organize logs, draft code, summarize project history, trigger workflows, and turn scattered ideas into executable plans. In short, Hermes is the quiet engine behind AIone Lab's ability to move unusually fast without losing the thread.</p>
    </div>
  </div>
