  ...
  <section class="hero-section">
    <div class="hero-inner">
      ...
      <div class="hero-showcase">
        ...
        <a href="projects/ai-agent-terminal" class="hero-mini-card">
          <div class="hero-mini-media">
            <img src="assets/images/hermes_terminal_1.jpg" alt="AI Agent Terminal">
          </div>
          <span class="hero-mini-tag">AI Terminal</span>
          <h3 class="hero-mini-title">AI Agent Terminal</h3>
          <p class="hero-mini-desc">An all-in-one voice AI terminal connected to cloud or local models for coding and logs.</p>
        </a>
      </div>
    </div>
  </section>
