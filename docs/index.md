...
<div class="home-container">
  ...
  <section class="lab-hero" aria-labelledby="hero-title">
    ...
    <a class="hero-feature" href="projects/reachy-mini-hermes-agent/">
      <div class="feature-image"><video autoplay muted loop playsinline preload="metadata" tabindex="-1" draggable="false" aria-label="Reachy Mini robot demonstration" style="pointer-events:none; user-select:none;"><source src="assets/videos/reachymini.mp4" type="video/mp4"></video><span class="feature-label">From the workbench</span></div>
  ...
  <div class="bento-grid">
    ...
    <a href="projects/ai-agent-terminal/" class="bento-card">
      <div class="bento-content-wrapper">
        ...
        <div class="bento-image-wrapper"><img loading="lazy" decoding="async" src="assets/images/1.jpg" alt="AI Agent Terminal with display and keyboard"></div>
      </div>
    </a>
    ...
    <a href="projects/tank-motor-assembly/" class="bento-card">
      <div class="bento-content-wrapper">
        ...
        <div class="bento-image-wrapper">
          <img class="tank-gif" src="assets/videos/tank_v1.gif" alt="Mini Tank demonstration" loading="lazy" decoding="async" draggable="false" style="pointer-events:none; user-select:none;">
        </div>
      </div>
    </a>
    ...
    <a href="projects/three-key-wireless-macro-keyboard/" class="bento-card">
      <div class="bento-content-wrapper">
        ...
        <div class="bento-image-wrapper"><img loading="lazy" decoding="async" src="assets/images/keyboard.jpg" alt="Finished 3-key wireless macro keyboard"></div>
      </div>
    </a>
  </div>
  </section>
