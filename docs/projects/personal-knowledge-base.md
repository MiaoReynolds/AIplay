...
<video autoplay muted loop playsinline controls preload="metadata" style="display:block; width:100%; max-height:720px; object-fit:contain; margin:0 auto 2rem; border-radius:14px; background:#050816;">
...
![Personal knowledge base map](../assets/images/personal-knowledge-base-map.png)
