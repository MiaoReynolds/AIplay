...
<div class="aigc-container">
  ...
  <div class="aigc-grid">
    ...
    <div class="aigc-card"
         ...
         data-prompt="A breathtaking high-angle view from a modern luxury hotel suite. Floor-to-ceiling panoramic windows overlook a vast, deep valley and a majestic range of rugged mountains. The distant peaks are capped with glistening white snow under a clear, crisp blue sky. The sunlight casts soft shadows across the terraced mountain slopes. Inside, two minimalist wooden lounge chairs with cream cushions sit on a light-colored herringbone wood floor, flanking a low black circular coffee table. The atmosphere is serene, airy, and sophisticated. Hyper-realistic, 8k resolution, cinematic lighting, architectural photography style."
         data-title="Mountain View Suite"
         onclick="openPromptModal(this)">
      <img class="aigc-card-img" src="../assets/images/mountain1.png" alt="Mountain View Suite">
      <div class="aigc-card-body">
        <h3 class="aigc-card-title">Mountain View Suite</h3>
      </div>
    </div>
